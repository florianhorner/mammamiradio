...
| AI host language | 100% Italian, addresses listeners as `amici miei` — only song/artist/brand names and the guest host's Bavarian phraselets exempt | Roughly 70% English / 30% Italian: English carries the information; Italian carries the heart (greetings, exclamations, punchlines) including occasional complete Italian sentences |
