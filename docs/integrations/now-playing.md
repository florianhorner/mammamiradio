...
```json
{
  ...
  "now_playing": {
    ...
    "music_attribution": {
      ...
      "source_url": "https://www.jamendo.com/track/1093607",
      "credit": "\"Stitches ft. Shane MauX\" Lilly Wolf (jamendo.com), licensed under CC BY 3.0.",
      "modified": true,
