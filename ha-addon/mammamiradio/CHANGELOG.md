...
- **Host memories now come only from banter that really aired.** New listener theories and song reaction cues are extracted afterward from the final streamed script, so queued, skipped, fallback, or half-sent banter no longer teaches the station something the listener never heard.
