...
|------|-----------|---------------------|
| **Hear it first** | Nothing | The First Listen mini-show plays right here on this device, then Demo Radio uses the attributed offline starter collection and 21 reviewed Marco-and-Giulia host breaks. Stock copy and fallback voices remain underneath them, and recovery cover stays available while a damaged music source is repaired. |
