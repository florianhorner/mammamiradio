...
COPY: dict[str, dict[str, str]] = {
    "en": {
        ...
        # Moment Picker — a quiet audition before a frozen share choice.
        "moment_title": "Il momento",
        "moment_listen_title": "Listen to the moment",
        "moment_close_aria": "Close moment picker",
        "moment_listen": "Listen to the moment",
        "moment_pause": "Pause",
        "moment_continue": "Continue",
        "moment_listen_again": "Listen again",
        "moment_change_context": "Change context",
        "moment_context": "Context",
        "moment_listen_first": "Listen before sharing",
        "moment_share": "Share this moment",
        "moment_cancel": "Cancel",
        "moment_preparing": "Preparing your moment…",
        "moment_ready": "Your moment is ready to hear.",
        "moment_auditioning": "Playing your selected moment.",
        "moment_share_ready": "You can share this moment now.",
        "moment_followup": "Try again shortly for the reaction.",
        "moment_try_again": "Try again",
        "moment_saving": "Saving your moment…",
        "moment_shared": "Your moment is ready to send.",
        "moment_share_cancelled": "Still yours to share when you're ready.",
        "moment_no_audio": "Nothing to replay just yet — let the radio play for a moment, then try again.",
        "moment_expired": "That moment has passed — make a fresh one when the next moment lands.",
        "moment_busy": "The tape decks need a moment — try again shortly.",
        "moment_error": "That moment didn't come through — give the radio a moment and try again.",
        "moment_audio_error": "That moment could not start — give the radio a moment and listen again.",
        "moment_rate_limited": "The tape decks need {s}s before the next moment — try again then.",
        "moment_copy_prompt": "Copy this moment:",
    },
    "it": {
        ...
        "moment_title": "Il momento",
        "moment_listen_title": "Ascolta il momento",
        "moment_close_aria": "Chiudi il selettore del momento",
        "moment_listen": "Ascolta il momento",
        "moment_pause": "Pausa",
        "moment_continue": "Continua",
        "moment_listen_again": "Ascolta di nuovo",
        "moment_change_context": "Cambia contesto",
        "moment_context": "Contesto",
        "moment_listen_first": "Ascolta prima di condividere",
        "moment_share": "Condividi questo momento",
        "moment_cancel": "Annulla",
        "moment_preparing": "Preparo il momento…",
        "moment_ready": "Il tuo momento è pronto da ascoltare.",
        "moment_auditioning": "Sto riproducendo il momento che hai scelto.",
        "moment_share_ready": "Ora puoi condividere questo momento.",
        "moment_followup": "Riprova tra poco per sentire la reazione.",
        "moment_try_again": "Riprova",
        "moment_saving": "Sto salvando il momento…",
        "moment_shared": "Il tuo momento è pronto da inviare.",
        "moment_share_cancelled": "Resta tuo da condividere quando vuoi.",
        "moment_no_audio": "Ancora niente da riascoltare — lascia suonare la radio un attimo, poi riprova.",
        "moment_expired": "Quel momento è passato — creane uno nuovo quando arriva il prossimo.",
        "moment_busy": "I registratori hanno bisogno di un attimo — riprova tra poco.",
        "moment_error": "Quel momento non è arrivato — dai un attimo alla radio e riprova.",
        "moment_audio_error": "Quel momento non è partito — dai un attimo alla radio e ascolta di nuovo.",
        "moment_rate_limited": "I registratori hanno bisogno di {s}s prima del prossimo momento — riprova allora.",
        "moment_copy_prompt": "Copia questo momento:",
    },
}
