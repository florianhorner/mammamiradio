...
- **Host memories now come only from banter that really made it to air.** The station still lets hosts use listener memory while writing a break, but new listener theories and song reaction cues are extracted afterward from the final aired script. Queued, purged, skipped, fallback, or half-sent banter can no longer teach the station something the listener never heard.
