...
- **First Listen opens in English and recovers without losing your place.** The Admin station opening uses recorded Marco/Giulia voices; ordinary listener playback keeps its existing opening. Failed background checks offer recovery actions and keep saved progress. The final privacy save keeps the show open, and a first privacy choice no longer looks like a failed save.
