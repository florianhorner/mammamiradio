...
- Home Assistant add-on admin controls and pacing now save through Supervisor before live state changes, so managed restarts and updates restore the selection and failed saves leave the running station untouched.
