...
- **Host memories now come only from banter that cleanly streamed on the station timeline.** The station still lets hosts use listener memory while writing a break, but new listener theories and song reaction cues are extracted afterward from the final streamed script. Queued, purged, skipped, fallback, or half-sent banter can no longer teach the station from an unfinished or discarded draft.
