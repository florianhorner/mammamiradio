...
- **First Listen opens in English.** The Admin station opening uses recorded Marco/Giulia voices; ordinary listener playback keeps its existing Italian opening. Maintainers can regenerate just the welcome or Admin opening, with retained-pack validation before synthesis and rollback if publication fails.
