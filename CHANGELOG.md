...
- **The station's page in Home Assistant finally introduces itself.** Opening Mamma Mi Radio under Settings > Apps showed the one-line blurb and then nothing — Home Assistant looks for an intro file inside the app's own folder, and there had never been one. The stable listing now opens with a short description and a picture of the player, and the Edge listing carries a short note saying plainly that it is not the one to listen to every day.
