...
- **Shared moments now say only what the station can prove.** Their public page shows the duration recorded with the clip, and leaves it unsaid when older metadata cannot prove it. When a song cannot be shared, the listener is told that only included tracks qualify and to tap Share within 15 seconds after one ends.
