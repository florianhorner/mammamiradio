...
- **A rare production hiccup can no longer leave dead air.** If the station hits an unexpected error while putting together the next segment, it now reaches for real backup audio — a pre-recorded clip, a recently cached track, or the last song that played — before ever resorting to a brief on-air tone, instead of inserting silence.
