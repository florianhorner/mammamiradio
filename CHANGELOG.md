...
- **Contributors now get one shared Conductor contract for commit and pull-request writing.** The repository mirrors its pinned GitHub rules before a PR is created, while local hooks and GitHub Actions remain the enforcement layer.
