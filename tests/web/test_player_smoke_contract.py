...
def test_player_smoke_pins_the_listener_interaction_contract() -> None:
    ...
    for needle in (
        ...
        "__rotationStatRenders",
        "Known empty rotation did not render zero",
        "Missing rotation count used played or queue fallback",
        "Source without rotation count did not render unavailable",
        "Negative rotation count did not render unavailable",
        "String rotation count did not render unavailable",
