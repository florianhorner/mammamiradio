...
def test_first_listen_browser_smoke_contract_is_deterministic() -> None:
    ...
    for needle in (
        ...
        "runCalmJourneySmoke",
        "all five stages do not read as one journey",
        ...
        "long speaker name was not retained as harmless text",
        ...
        "play success with a mismatched entity",
        "play receipt failure with a mismatched entity",
        "receipt retry without accepted proof",
        "receipt retry with a mismatched entity",
        "verification with a mismatched attempt echo",
        ...
        "discovery without a ready canonical media source",
        "discovery with the wrong media source URI",
        "transport-aborted Search again retained stale radios",
        "stale selected target played after transport-aborted discovery",
        "transport abort did not preserve the genuine pending receipt only",
        "pending receipt recovery replayed the station after transport abort",
        "unreachable discovery hid its connection failure",
        "empty discovery hid its repair guidance",
        ...
        "speaker retest discovery did not expose deliberate choices",
        ...
        "choose another speaker left a generated radio checked",
        "[320, 568]",
        "[375, 667]",
        "[430, 932]",
        "[768, 1024]",
    ...
    for exercised_control in (
        "receiptRetryFailuresRemaining",
        "discardNextPlayResponse",
        "failNextPrivacyReceipt",
        "ambientOnlyPreview",
        "failNextPlayerDiscovery",
        "playerCandidatesAvailable",
    ...
    assert code.count("DISCOVERY_UNAVAILABLE_STATUS") == 2, "unreachable discovery must exercise HTTP 503"
