...
def test_first_listen_browser_smoke_contract_is_deterministic() -> None:
    ...
    for needle in (
        ...
        "runCalmJourneySmoke",
        "polling failure was silent",
        "polling failure changed saved progress or focus",
        "unchanged setup response failed to restore readiness",
        "readiness received numbered human progress",
        "completion polling navigated away from the show",
        "noninteractive step status still looks like a button",
        "healthy readiness made optional sources look required",
        "music repair falsely claimed First Listen complete",
        "required First Listen path is not three stages",
        ...
        "reload-resume",
        "Home consent still gates writing",
        "polling hid unfinished replacement input",
        "polling stole unfinished key focus",
        "key check lost Retry",
        "recheck did not probe the connection",
        "replacement inherited the old key success after failed refresh",
        "connected writing repeats its receipt",
        "completed writing Back focused a hidden heading",
        "Resume replayed the opening or duplicated the stream",
        "returning sound check promised a fresh opening",
        "returning sound check showed a transcript for audio it will not play",
        "for(const stage of ['invite','writing','voices','home'])",
        "stopped-continue-force-success",
        "undo notice covers player",
        "household-scene",
        ...
        "natural completion hid proof Replay",
        "natural completion stole focus",
        "household-example-sequence",
        "household-example-private-exit",
        "failed optional recording blocked setup",
        "private exit left an optional example playing",
        "evening completion autoplayed another recording",
        "back from a pending example advanced completion",
        "made the remaining recordings compulsory",
        "recorded examples read or changed Home context",
        "restart retained the example sequence from the earlier journey",
        ...
        "paused-completion",
        "old confirmation unlocked replay after No sound yet",
        "disconnected listener hid its recovery action",
        "idle onboarding claimed station headset controls",
        "polling replayed the celebration",
        "standalone welcome returned as a competing action",
        "assertGuideRequests(freeBaseline,'free-voices')",
        "voice_examples\\/free-voices",
        "rememberGuideAudioRequest",
        r"/\/static\/audio\/(?:first_listen|voice_examples|home_moments)\/[^/?]+\.mp3(?:\?|$)/",
        ...
        "No sound yet was not recorded explicitly",
        ...
        "missing-ok response incorrectly completed Home review",
        ...
        "Jamendo setup did not open inside Rotazione",
        ...
        "readiness heading drifted from music continuity",
        "readiness overpromised primary music readiness",
        ...
        "native music readiness disclosure is missing",
