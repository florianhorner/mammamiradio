...
def test_load_explicit_source_sets_jamendo_track_source(config, monkeypatch):
    ...
    monkeypatch.setattr("mammamiradio.playlist._fetch_jamendo_playlist", lambda *_args, **_kwargs: jamendo_tracks)
...
def test_load_explicit_source_sets_chart_and_local_track_sources(config, tmp_path, monkeypatch):
    from mammamiradio.playlist import _load_chart_source_tracks, load_explicit_source
    ...
    monkeypatch.setattr("mammamiradio.playlist._fetch_current_italy_charts", lambda: chart_tracks)
