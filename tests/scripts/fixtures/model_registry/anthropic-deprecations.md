<!-- Trimmed real capture of https://platform.claude.com/docs/en/about-claude/model-deprecations.md
     (2026-09-08): everything through the first 'Deprecation history' section; the rest of the history and
     the parameter-deprecation table were removed. -->
---
...
<!-- ... older deprecation history removed from the capture ... -->
